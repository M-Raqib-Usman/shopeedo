  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Top row – logo + location + right icons */}
        <div className="h-14 flex items-center justify-between">
          ...
          <button className="flex items-center gap-1.5 text-sm font-medium text-gray-700 hover:text-orange-600 transition-colors">
            ...
            <span className="hidden xs:inline">Fort Abbas, Punjab</span>
          ...
          <div className="flex items-center gap-5 sm:gap-7">
            <button className="relative text-gray-700 hover:text-orange-600 transition-colors">
              ...
              <span className="absolute -top-1.5 -right-1.5 bg-red-500 text-white text-[10px] font-medium min-w-[16px] h-4 rounded-full flex items-center justify-center px-1">
                0
              </span>
            </button>
        ...
        {/* Second row – search bar + optional nav links */}
        <div className="h-14 flex items-center border-t border-gray-100 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
          ...
          <div className="w-full max-w-2xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2.5 bg-gray-100/80 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-orange-400/50 transition"
            />
          </div>
